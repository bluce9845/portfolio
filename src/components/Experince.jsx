          ...
          <div className="wrap-chat-bublle" data-aos="fade-right">
            <div className="position-relative p-3 ms-5 shadow chat-bubble">
              <p className="ct-experience-params">
                As a fresh graduate in Software Engineering, I may not yet have formal work experience, but I am eager to bring my knowledge and enthusiasm to a professional setting. My journey so far has equipped me with a strong
                foundation in programming, particularly in PHP, Laravel, Django, React, and JavaScript, gained through rigorous training programs and hands-on projects. I am committed to continuous learning and self-improvement. While I
                work on real-world projects, I aim to further enhance my technical skills, including mastering frameworks and improving my problem-solving abilities.
                <br />
